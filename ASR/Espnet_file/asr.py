...
from espnet2.asr.encoder.conformer_encoder_mamba import ConformerEncoderMamba
from espnet2.asr.encoder.transformer_mamba_encoder import TransformerEncoder_Mamba
...
encoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        mamba=ConformerEncoderMamba,
        transformer_mamba=TransformerEncoder_Mamba,
    ),
