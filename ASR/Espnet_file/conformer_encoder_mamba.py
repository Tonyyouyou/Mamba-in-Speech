# Copyright 2020 Xiangyu Zhang, Tianyi Xiao
...
class ConformerEncoderMamba(AbsEncoder):
    ...
    def __init__(
        ...
        elif pos_enc_layer_type == "mamba" or pos_enc_layer_type == "bimamba" or pos_enc_layer_type == "bimamba_cat":
            pos_enc_class = PositionalEncoding
        else:
        ...
        if mamba_type == "mamba":
        ...
        elif mamba_type == "bimamba_cat":
            encoder_selfattn_layer = BiMamba_cat
            encoder_selfattn_layer_args = (
                output_size,
                d_state,
                d_conv,
            ...
            raise ValueError("unknown encoder_mamba_layer: " + mamba_type)
